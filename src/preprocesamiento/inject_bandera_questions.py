...
QUESTIONS_BY_BOOK: dict[str, list[str]] = {
    "la_metamorfosis_franz_kafka": [
        ...
        "pieles en medio del vaciamiento de su habitación?",
        "¿Cómo ha cambiado el padre físicamente y en su actitud desde que "
        "Gregorio dejó de trabajar?",
    ...
    "el_maravilloso_mago_de_oz_baum_lyman_frank": [
        "¿Cómo es la vida de Dorothy en Kansas antes del ciclón?",
        "Dorothy conoce al Espantapájaros. ¿Qué desea este personaje y por qué?",
        "Dorothy y el Espantapájaros encuentran al Leñador de Hojalata. ¿Qué simboliza su deseo de tener un corazón?",
        "Aparece el León Cobarde. ¿Por qué se considera cobarde y qué actos de valentía realiza sin darse cuenta?",
        "El grupo cruza el campo de amapolas. ¿Qué peligro enfrentan y cómo se ayudan entre sí?",
        ...
        "Llegan a la Ciudad Esmeralda y conocen al Mago de Oz. ¿Qué impresión les causa?",
        "El Mago les ordena matar a la Bruja Maligna de Occidente. ¿Qué revela esta misión sobre el verdadero carácter del Mago?",
        "Tras derrotar a la bruja, el grupo descubre que el Mago es un hombre común. ¿Cuál es la gran lección que aprenden Dorothy y sus amigos?",
    ],
    "el_viejo_y_el_mar_ernest_hemingway": [
        "¿Cómo se describe al viejo Santiago al inicio de la historia?",
        "¿Cómo es la relación entre Santiago y Manolín?",
        "Santiago y Manolín hablan de béisbol y de los grandes jugadores. ¿Por qué Hemingway incluye estas conversaciones?",
        "El viejo y el muchacho fingen que tienen comida y una atarraya. ¿Por qué mantienen esta ficción?",
        "Santiago se prepara para salir solo al mar. ¿Qué sentimientos experimenta?",
        ...
        "Santiago rema mar adentro y reflexiona sobre el mar, los peces voladores y las aves. ¿Qué relación tiene con la naturaleza?",
        "El viejo lanza sus sedales con precisión. ¿Cómo demuestra su experiencia y conocimiento del mar en esta escena?",
        "Mientras espera, Santiago reflexiona sobre su soledad. ¿Qué piensa del mar y de su lugar en él?",
        "El gran pez muerde el anzuelo. ¿Cómo reacciona Santiago?",
        ...
        "La batalla con el pez continúa. Santiago sufre calambres y dolor. ¿Cómo soporta el sufrimiento físico?",
        "El viejo come el bonito crudo para mantenerse fuerte. ¿Qué demuestra esto sobre su voluntad de sobrevivir?",
        "Santiago por fin ve el pez cuando salta fuera del agua. ¿Cómo describe su tamaño y belleza?",
        ...
        "Después de días de lucha, Santiago finalmente arponea al pez. ¿Qué siente en ese momento?",
        "Santiago amarra el pez al bote y emprende el regreso. ¿Qué peligros presiente?",
        ...
        "Llega el primer tiburón. ¿Cómo defiende Santiago al pez y qué pierde en el ataque?",
        "Santiago reflexiona sobre si fue un pecado matar al pez. ¿Qué está cuestionando realmente?",
        "Llegan más tiburones. Santiago ahora lucha con un cuchillo amarrado a un remo. ¿Cómo cambia su actitud?",
        "El viejo pierde el cuchillo y sigue peleando. ¿Por qué sigue luchando si sabe que está perdiendo?",
        "Llegan los galanos al anochecer. ¿En qué se diferencia su ataque de los anteriores?",
        "Santiago golpea a los tiburones con el cabo del timón hasta que no queda nada. ¿Qué representa esta lucha final?",
        "Santiago llega a la costa de noche con el esqueleto del pez. ¿Fue derrotado o victorioso?",
    ],
